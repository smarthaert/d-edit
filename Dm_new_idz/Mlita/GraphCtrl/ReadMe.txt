========================================================================
		ActiveX Control DLL : GRAPHCTRL
========================================================================

ControlWizard has created this project for your GRAPHCTRL ActiveX Control
...
that make up your GRAPHCTRL ActiveX Control DLL.
...
GraphCtrlCtl.h
	This file contains the declaration of the CGraphCtrlCtrl C++ class.

GraphCtrlCtl.cpp
	This file contains the implementation of the CGraphCtrlCtrl C++ class.

GraphCtrlPpg.h
	This file contains the declaration of the CGraphCtrlPropPage C++ class.

GraphCtrlPpg.cpp
	This file contains the implementation of the CGraphCtrlPropPage C++ class.

GraphCtrlCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGraphCtrlCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GraphCtrl.rc.
