...
BEGIN_MESSAGE_MAP(CGraphDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	ON_WM_CLOSE()
	ON_COMMAND(ID_VIEW_SHOWPROPERTIESWINDOW, OnViewShowpropertieswindow)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
BOOL CGraphDlg::OnInitDialog()
{
	...
	pPropDlg = new CPropertiesDlg;
	pPropDlg->Create(IDD_PropertiesDlg,NULL);
	pPropDlg->ShowWindow(SW_SHOW);
...
void CGraphDlg::OnViewShowpropertieswindow() 
{
	if (pPropDlg->IsWindowVisible()) pPropDlg->ShowWindow(SW_HIDE); else pPropDlg->ShowWindow(SW_SHOW);
