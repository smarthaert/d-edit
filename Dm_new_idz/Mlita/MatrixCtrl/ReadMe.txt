========================================================================
		ActiveX Control DLL : MATRIXCTRL
========================================================================

ControlWizard has created this project for your MATRIXCTRL ActiveX Control
...
that make up your MATRIXCTRL ActiveX Control DLL.
...
MatrixCtrlCtl.h
	This file contains the declaration of the CMatrixCtrlCtrl C++ class.

MatrixCtrlCtl.cpp
	This file contains the implementation of the CMatrixCtrlCtrl C++ class.

MatrixCtrlPpg.h
	This file contains the declaration of the CMatrixCtrlPropPage C++ class.

MatrixCtrlPpg.cpp
	This file contains the implementation of the CMatrixCtrlPropPage C++ class.

MatrixCtrlCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CMatrixCtrlCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file MatrixCtrl.rc.
