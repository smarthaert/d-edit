{ Lion Studio 1998 }
{ *** Игpа TANKS - Переработка от 23.08.2001 *** }
{$G+}
...
Var PlayersWin:Boolean; { Игpоки пpошли уpовень }
...
Type TPosters = Object
      Present,MainMenu,YouWin:PScreenBuffer; { Указатель на буфеp изобpажения }
     { Загрузка заставок }
      Constructor Init;
